	<!-- Start webboard -->
				<div class="row my-5 justify-content-center " id="show-webboard">
					<div class="col-md-12 col-lg-8 col-sm-12">
						<div class="alert alert-light rounded-pill border-4 border-dark h4 text-center">กระดาษสนทนา</div>

<div class="card">
            <div class="card-body">
              <h4 class="bg-primary card-header mb-2">เรื่องสนทนาทั้งหมด</h4>
              <table class="table table-hover table-info">
				...
				<!-- <a href="index-show-webboard.php" class="btn btn-primary d-grid mt-2">ดูทั้งหมด</a> -->
					</div>
