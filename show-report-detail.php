		...
		<div class="row my-5 justify-content-center">
			<div class="col-md-12 col-lg-8 col-sm-10">
				<a href="show-all-report.php" class="btn btn-warning my-2"><-- Back</a>
						<div class="alert bg-secondary rounded-pill border-4 border-light h4 text-center text-light">
							รายงานแบบสอบถาม</div>
							...
							<div class="card-body">
								...
								<div class="alert alert-danger">
									...
									<strong class="text-danger h5">
										<?php echo $row_show_report->report_topic; ?>
									</strong>
									<br>
								...
								while ($row = mysqli_fetch_object($result)) {
									...
									<div class="alert alert-info mt-3">
										...
										<div class="progress" style="height: 50px;">
											<div class="progress-bar text-dark <?php echo $bg; ?>" role="progressbar"
												style="width: <?php echo $percentage; ?>%; h"
												aria-valuenow="<?php echo $percentage; ?>" aria-valuemin="0"
												aria-valuemax="100">
												<p class="h4 ">
													<?php echo number_format((float) $percentage, 2, '.', ''); ?>%
												</p>
											</div>
											<div class="progress-bar bg-secondary" role="progressbar"
												style="width: <?php echo $balance; ?>%; h"
												aria-valuenow="<?php echo $balance; ?>" aria-valuemin="0"
												aria-valuemax="100"></div>
										</div>

										<a href="#show_detail_score_<?php echo $i; ?>" data-bs-toggle="modal"
											class="float-end">รายละเอียด</a>
										<br>
										<!-- modal detail report -->
											...
											<div class="modal-dialog modal-dialog-centered">
												<div class="modal-content">
													...
													<div class="modal-body">
														...
														<h4>คะแนนเต็มในหัวข้อนี้คือ : <?php echo $report_score; ?> คะแนน
														</h4>
														<hr>
														<?php
														...
														if ($count != 0) {
															while ($row_detail_score = mysqli_fetch_object($result_detail_score)) { ?>
																<h5>ประเมิน <?php echo $row_detail_score->use_score_report ?> คะแนน
																	จำนวน <?php echo $row_detail_score->count_score ?> คน</h5>

															<?php } ?>
															<hr>
															<h5>รวมคะแนนเต็ม <?php echo $total; ?> คะแนน </h5>
															<h5>รวมคะแนนที่ได้ <?php echo $sum_score; ?> คะแนน คิดเป็นร้อนละ
																<?php echo number_format((float) $percentage, 2, '.', ''); ?> %
															</h5>
														<?php } else {
														}
