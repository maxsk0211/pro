...
<html lang="en">
  ...
  <body style="height: 5000px; padding-top: 70px;background: rgb(100, 40, 140);">
     ...
     <div class="row">
       ...
       <div class="col-md-9">
          <a href="users-add-webboard.php" class="btn btn-warning btn-lg"><--- Back</a>
         ...
         // }
          ...
          <form action="sql/insert-comment.php" method="post" enctype="multipart/form-data">
                  <div class="card mt-3">
                    <div class="card-body">
                      <div class="row">
             <?php 
