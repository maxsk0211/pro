...
$sql="UPDATE users SET usernames = '$usernames', passwords = '$password', fname = '$fname', lname = '$lname', tel = '$tel', address = '$address', pic = '$name_file_pic', birthday = '$birthday' WHERE users.id_user = '$id_user'";
